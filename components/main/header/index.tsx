  ...
  return (
    <div className="relative flex flex-col w-full">
      <div className="relative flex justify-center w-full dt:h-[80px] h-[65px]">
        <div className="fixed top-0 left-0 w-full dt:h-[80px] h-[65px] bg-[#FFFFFF] border-b-[1px] border-[#D4D4D4] z-10" />
        <div className="fixed top-0 flex tb:justify-center justify-end items-center dt:max-w-[1008px] w-full dt:h-[80px] h-[65px] tb:px-0 px-[16px] bg-[#FFFFFF] border-b-[1px] border-[#D4D4D4] z-20">
