...
export default function Card() {
  ...
  return (
    <div className='flex ph:flex-row flex-col  p-[24px] ph:space-x-[24px] space-x-0 rounded-[10px] shadow-[0px_3px_10px_rgba(0,0,0,0.16)]'>
      ...
      <Image src={emptyImg} className='ph:w-[394px] w-full ph:h-[345px] h-[258px] !m-0 rounded-[10px]' width={0} height={0} alt="" />
      <div className='relative flex flex-col grow space-y-[40px]'>
        ...
        <div className='relative flex tb:flex-row flex-col tb:space-x-[24px] space-x-0 tb:space-y-0 space-y-[24px]'>
          <div className='flex flex-col flex-1 space-y-[16px]'>
            <p className='text-[20px] font-bold'>아바타 설명</p>
            <div>
              버츄얼 아이돌 이세돌의 주르르 입니다. ^~^ 생방송은 트위치에서! 앙 트위띠~
            </div>
          </div>
          <div className='relative flex flex-col flex-1 space-y-[32px]'>
            ...
            <div className='flex flex-col space-y-[16px]'>
              ...
              <div
                className='flex flex-row space-x-[10px] whitespace-nowrap overflow-x-scroll scrollbar-hide text-[14px]'
                {...dragEvents}
                ref={dragRef}
              >
        ...
        {/* <div className='flex justify-end w-full'>
          <div className='flex space-x-[16px]'>
            <div className='flex justify-center items-center w-[116px] h-[42px] rounded-[10px] bg-[#FFFFFF] border-[1px] border-solid border-[#D4D4D4] cursor-pointer'>삭제하기</div>
            <div className='flex justify-center items-center w-[116px] h-[42px] rounded-[10px] bg-[#368ADC] text-[#FFFFFF] cursor-pointer'>수정하기</div>
          </div>
        </div> */}
      </div>
    </div>
